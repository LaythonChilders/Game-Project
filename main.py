...
# Singleton implementation for CatDoom
class CatDoom:
    _instance = None

    def __new__(cls, *args, **kwargs):
        if not cls._instance:
            cls._instance = super(CatDoom, cls).__new__(cls, *args, **kwargs)
    ...
    def check_events(self):
        ...
        for event in pygame.event.get():
            ...
            elif event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE:  # Pause menu
...
if __name__ == '__main__':
    catGame = CatDoom()  # Singleton instance
    catGame.setup_game()
